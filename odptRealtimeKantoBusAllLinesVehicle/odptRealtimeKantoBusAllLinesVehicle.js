...
const KANTO_BUS_DATA_SOURCES = {
  vehicle: {
    endpoint: "https://odpt-proxy.ezato.workers.dev/gtfs/kantobus/vehicles",
    label: "車両位置",
    countLabel: "表示車両数",
    unit: "台",
  ...
  trip: {
    endpoint: "https://odpt-proxy.ezato.workers.dev/gtfs/kantobus/trip",
    label: "ルート更新情報",
    countLabel: "更新便数",
    unit: "便",
  ...
  alert: {
    endpoint: "https://odpt-proxy.ezato.workers.dev/gtfs/kantobus/alert",
    label: "運行情報",
    countLabel: "運行情報件数",
    unit: "件",
