...
const ICON_RULES = [
  ...
  { index: 1, label: "飲食店", symbol: "restaurant", keywords: ["食材の店", "飲食店", "レストラン"] },
  { index: 14, label: "店舗・営業", symbol: "storefront", keywords: ["食品営業", "営業許可", "店舗", "事業所"] }
];
